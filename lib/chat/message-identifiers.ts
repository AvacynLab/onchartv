...
/**
 * Identifier utilities used by the chat surface and its tests to stabilise the
 * message collection while the upstream SDK streams payloads. Keeping the
 * normalisation logic in this module avoids scattering identifier generation
 * across components and provides a single entry point for Playwright
 * diagnostics.
 */
