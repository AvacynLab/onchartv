...
/**
 * Lightweight helpers that keep assistant lifecycle attributes consistent
 * during streaming. Components can rely on these utilities to decide whether a
 * given bubble should expose `streaming` or `completed` without depending on
